...
Run `npm run build` to create a Windows installer. It'll show up in `dist/Nthing Setup 1.9.2.exe`. There's also `npm run build:portable` if you want a standalone exe.
